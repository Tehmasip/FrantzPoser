...
namespace CustomizableAnimeGirl
{
	public class AutoBlink : MonoBehaviour
	{
		...
		public SkinnedMeshRenderer ref_SMR_FACE_DEF;	//FACE_DEFへの参照
		...
		void SetCloseEyes ()
		{
			ref_SMR_FACE_DEF.SetBlendShapeWeight (17, ratio_Close);
			ref_SMR_EL_DEF.SetBlendShapeWeight (6, ratio_Close);
		}

		void SetHalfCloseEyes ()
		{
			ref_SMR_FACE_DEF.SetBlendShapeWeight (17, ratio_HalfClose);
			ref_SMR_EL_DEF.SetBlendShapeWeight (6, ratio_HalfClose);
		}

		void SetOpenEyes ()
		{
			ref_SMR_FACE_DEF.SetBlendShapeWeight (17, ratio_Open);
